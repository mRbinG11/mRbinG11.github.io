...
gulp.task("clean", function () {
  return gulp
    .src("../Resume/", { read: false, allowEmpty: true })
...
gulp.task("copy:images", function () {
  return gulp.src("./img/**").pipe(gulp.dest("../Resume/img"));
});

// PDFs
gulp.task("copy:pdfs", function () {
  return gulp.src("./*.pdf").pipe(gulp.dest("../Resume"));
});
...
gulp.task(
  "default",
  gulp.series(gulp.parallel("css+js", "clean"), gulp.parallel("copy", "usemin"))
);
